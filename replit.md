...
- Demo user system (authentication not yet implemented - currently using "demo-user" ID)
...
**AI Services**
- OpenAI API for chat completions (Coder and Tutor panels)
- OpenAI client library (`openai` npm package) configured with API key from environment
- Artist panel uses AI to generate Mermaid diagram syntax from natural language prompts
